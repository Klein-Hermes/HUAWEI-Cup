...
1,819 个唯一名称候选中，C1 `Hub License` 原始字段有值 1093 条、为空 726 条；C2 `Open Weights=Yes` 有 201 条，其中 C1 License 字段为空 68 条。逐候选原值见 `../03_结果/results/q4_license_source_audit.csv`。
