# Q4 输入合同 v0.1（2026-09-25 历史草案）

> **版本范围：** 本合同的未决项反映 v0.1 起草时的状态，不代表现行分析口径。Q4 后续已确认口径并于 2026-09-26 获用户授权冻结；现行入口见[当前样本与口径决策单](../../../../01_方案说明/q4_cohort_decision.md)和[冻结包说明](../../../../05_审计交付/q4_freeze_package.md)。下文保留 v0.1 的原始待决事项供版本追溯。
...
上述未决项是 `q4_cohort_decision.md` 的人工决策输入，确认前不进入最终 Q4 聚合、分解或前沿结论。
