...
本目录是便于集中查看和交接的审计副本。权威版本仍保存在 03_结果/经典ScalingLaw基线/v1/；如需编辑，以该目录为准，再同步更新本副本。

- b4_b5_loss_comparability_audit.md：截图步骤判定、B4/B5 对 B1 的比较等级与后续门禁。
- loss_protocol_matrix.csv：按来源组整理的协议字段；N/D 是范围和记录数，未知值明确写作 UNKNOWN。
