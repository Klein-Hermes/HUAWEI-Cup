...
``Q3/03_代码/图表源/plot_q3_supplementary_figures.py``. Its hash and the
hashes of all data inputs are recorded in the generated local manifest.
"""
...
PAPER_DIR = PROJECT_ROOT / "Q3/04_结果/figures/_rebuild_supplementary_paper"
...
def write_manifest(core, figures: dict[str, list[str]], statistics: dict, style_info: dict, audits: dict, decision_path: Path) -> Path:
    ...
    manifest = {
        ...
        "command_from_project_root": r"python Q3/03_代码/图表源/论文版/plot_q3_supplementary_figures_paper.py",
        "python": sys.version,
