...
本快照整合 T1/M3/M4、T2、T3、T4 与新增预算覆盖分析。结论范围是固定 Q₀ 与冻结 M0 下的 B1 观测 N/D 支持域；T4 是条件敏感性。完整经验 Q/p 联合优化仍未识别，因此本包不是完整 Q3 联合最优结果，也不是竞赛论文提交包。
...
- [独立范围 P2 复核回执（PASS）](QA/P2_independent_release_receipt.md)。
