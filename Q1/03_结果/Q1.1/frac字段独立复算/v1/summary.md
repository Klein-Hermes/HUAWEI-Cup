...
| `rps_doc_frac_no_alph_words` | public_document_formula_x100 | 4.34783–100 | 51230 | 0 | 521/51230 (0.01017) | 6.75068 | 51.5957 |
...
```powershell
python src/q1_1_frac_field_recalculation_audit.py --output-dir results/q1_1/fraction_recalculation_audit/v1
```
