...
declare -a JOBS=(
  "Q1.1-flow-score.html:992:896:q1-flow-score.png"
  "Q1.2-flow-conflict.html:1232:760:q1-flow-conflict.png"
  "Q1.3-flow-mixture.html:1232:956:q1-flow-mixture.png"
  "Q2-flow-scaling.html:1312:1280:q2-flow-scaling.png"
)
